function H = DynamicBC_connectogramOutlierB(numSlices,rextend,colorFrame2,colorFrame,mod,r2,line_widthtype,abovetype,linefactor,colortype,modcolor,nodes)
...
DynamicBC_connectogramInnerB(r2, ccolor, congram.aH, th,  line_widthtype,mod,abovetype,linefactor,colortype)
