function H = DynamicBC_connectogramOutlierW(numSlices,rextend,colorFrame2,colorFrame,mod,r2,line_widthtype,abovetype,linefactor,colortype,modcolor,nodes)
...
DynamicBC_connectogramInnerW(r2, ccolor, congram.aH, th,  line_widthtype,mod,abovetype,linefactor,colortype)
